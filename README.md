...
| `EXO_DEEPSEEK_V4_POST_DECODE_PROMOTION` | Retain completed DeepSeek V4 decode state as an exact-prefix candidate while preserving the pre-decode fallback. Set to `false` to disable. Requires at least two V4 cache entries. | `true` |
